...
def patch_base_class(mocker):
    ...
    mocker.patch.object(SnowflakeStream, "path", "v0/example_endpoint")
    mocker.patch.object(SnowflakeStream, "primary_key", "test_primary_key")
    mocker.patch.object(SnowflakeStream, "__abstractmethods__", set())
